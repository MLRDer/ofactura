...
$this->title = Yii::t('main', 'Update Facturas: {name}', [
    'name' => $model->Id,
]);
...
$this->registerJs("document.getElementById(\"BuyerTin\").value =".$model->BuyerTin." ; GetDataByTinV2ForUpdate(".$model->BuyerTin.");ChangeTypeFactura(".$model->FacturaType.");",\yii\web\View::POS_END);
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="row m-b-50">
                ...
                <div class="col-md-6">
                    <div class="info-block-wrapper show-block">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="second-input">
                    ...
                    <div class="change-info-block-wrapper ">
                        <div class="row">
                            <div class="col-md-6">
