...
$this->title = Yii::t('main','Create Company Users');
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="kt-portlet__head-toolbar">
            ...
            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                ...
                <button  id="Savebtn" onclick="SaveCompanyUsers()" type="button" class="btn btn-success">
                    <i class="la la-floppy-o"></i> <?= Yii::t('main','saqlash')?></button>
