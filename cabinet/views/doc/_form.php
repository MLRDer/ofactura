...
<div class="row">
    ...
    <div class="col-md-12" style="padding-top: 20px">
        ...
        <div class="kt-section__content kt-section__content--solid">
            ...
            <a href="/docs/factura.xlsx" class=" btn btn-warning" style="margin-bottom: 7px;"> <?= Yii::t('main','Skachat factura')?></a>
...
"></i> <?= Yii::t('main','Добавить ещё')?></button>
    ...
    <?php } else {?>
        ...
        <?= $form->field($model, 'json_items')->textInput(['id' => "items_json"])->label(false) ?>
...
<script>
    $(document).ready(function(){
        ...
        $(".add-row").click(function(){
            ...
            if(isAksis==true){
                var markup = "<tr><td align='center'><label class='kt-checkbox kt-checkbox--brand'><input type='checkbox' name='record'><span style='top: 4px;left: 5px;'></span></label></td><td>" + ProductName + "</td><td>" + ProductMeasureId + "</td><td>"+ProductCount+"</td><td>"+ProductSumma+"</td><td>"+ProductDeliverySum+"</td><td>"+ ProductFuelRate +"</td><td>"+ProductFuelSum+"</td><td>"+ProductDeliverySumWithFuel+"</td><td>"+ProductVatRate+"</td><td>"+ProductVatSum+"</td><td>"+ProductDeliverySumWithVat+"</td> </tr>";
            } else {
