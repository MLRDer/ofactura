...
$aktiv_company = \common\models\Company::find()->where('status=1')->count();

$total_docs_success_send = \common\models\Invoices::find()->where("(created_date BETWEEN '{$start_date}' and '{$end_date}') and type_invoices=0")->count();
$total_davernost_success_send = \common\models\Invoices::find()->where("(created_date BETWEEN '{$start_date}' and '{$end_date}') and type_invoices=0 and tarif_id>0")->count();
