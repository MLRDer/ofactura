                ...
                [
                    ...
                    'value'=>function($model){
                        ...
                        if($model->type==\common\models\Docs::TYPE_IN){
                            $res = '<button type="button" class="btn btn-outline-success btn-icon"><i class="la la-arrow-down"></i></button>';
                        }

                        if($model->type==\common\models\Docs::TYPE_OUT){
                            $res = '<button type="button" class="btn btn-outline-warning btn-icon"><i class="la la-arrow-up"></i></button>';
                        }
                        return $res;
                    }
                ],
...
//                ],
                [
                    ...
                    'value'=>function($model){
                        ...
                        $html = '<span class="kt-badge  kt-badge--'.$statuModel['class_name'].' kt-badge--inline kt-badge--pill">'.$statuModel['name_'.Yii::$app->language].$model->status.'</span>';
                        return $html;
                    }
                ],
                [
