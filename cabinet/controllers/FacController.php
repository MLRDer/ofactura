...
/**
 * FacController implements the CRUD actions for Factura model.
 */
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Factura",
                    'content'=>'<span class="text-success">Create Factura success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
