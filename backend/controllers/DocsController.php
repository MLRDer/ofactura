 ...
 */
class DocsController extends \common\components\Controller
{

     public function actionIndex()
    {    
        $searchModel = new DocsSearch();
        $dataProvider = $searchModel->searchToAdmin(Yii::$app->request->queryParams);
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Docs",
                    'content'=>'<span class="text-success">Create Docs success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
