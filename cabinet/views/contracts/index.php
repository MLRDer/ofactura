...
/* @var $searchModel common\models\ContractsSearch */
    ...
    <div class="row m-b-20">
        ...
        <div class="col-md-6">
            <div class="d-flex justify-content-end">
                <a href="/contracts/create" class="btn-gray border-right-0-margin-right-30 color-blue">+ <?= Yii::t('main','Создать новую dogovor')?></a>
            </div>
            ...
            echo Tabs::widget([
                ...
                'items' => [
                    [
                        ...
                        'content' => $this->render('_columnsContracts',[
