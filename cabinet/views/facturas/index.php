...
$this->title = Yii::t('main','Счет-фактуры');
    ...
    <div class="row m-b-20">
        ...
        <div class="col-md-6">
            <div class="d-flex justify-content-end">
                <a href="/facturas/create" class="btn-gray border-right-0-margin-right-30 color-blue">+ <?= Yii::t('main','Создать новую фактуру')?></a>
            </div>
    ...
    <div class="row">
        ...
        echo Tabs::widget([
            ...
            'items' => [
                [
                    'label' => 'Входящие',
                    'content' => $this->render('_columnsFactura',[
