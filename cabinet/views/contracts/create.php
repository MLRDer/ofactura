...
<div class="white-box">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="input m-b-30">
                <?= $form->field($model, 'ContractNo',['template'=>'{input}{error}<a  href="/format-num/create" target="_blank" class="border-link">'.Yii::t('main','Настройка нумерация').' </a>'])->textInput(['maxlength' => true,'class'=>'','placeholder'=>'ContractNo'])->label(false) ?>
            </div>
        </div>
        <div class="col-md-4">
...
//                                                        'type' => DatePicker::TYPE_COMPONENT_APPEND,
        ...
        <div class="col-md-12">
            ...
            <?php foreach ($modelsParts as $index => $modelParts): ?>

            <div class="col-md-12 m-t-30 item-parts">
                <div class="part-area-title">
                    <div class="input-group">
                        <?= $form->field($modelParts, "[{$index}]Title",['template'=>'<div class="input-group-prepend">
