...
$this->title = Yii::t('main',"Tizimni rouming dan tasdiqlash");
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                                            ...
                                                            <div class="btn-group" role="group">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                                                                    <a class="dropdown-item" href="/uz/site/set-rouming">
                                                                        <img src="/img/uz.png" width="20px"> UZB
                                                                    </a>
                                                                    <a class="dropdown-item" href="/oz/site/set-rouming"><img src="/img/uz.png" width="20px"> OZB</a>
                                                                    <a class="dropdown-item" href="/ru/site/set-rouming"><img src="/img/ru.png" width="20px"> RUS</a>
                                                ...
                                                <div class="kt-portlet__body kt-portlet__body--fluid" style="height: calc(100vh - 150px);">
                                                    ...
                                                    <div class="kt-widget12">
                                                        <div style="height: calc(100vh -  250px);overflow: auto;">
                                                            <?= Yii::t('main','Tizim imkoniyatlaridan toliq foydalanish uchun rouming operatoridan tasdqilash lozim')?>


                                                        </div>
                                                         <div style="padding-top:20px">
                                                            <button class="btn btn-brand" onclick="AcceptOnline()">
                                                            ...
                                                            <a href="/site/logout" class="btn btn-danger">
                                                             ...
                                                             <span class="pull-right">
                                                                 <a href="/site/index" class="btn btn-light">
                                                                     <i class="la la-times"></i> <?= Yii::t('main','Davom etish')?>
                                                                 </a>
                                                             </span>
                                                         </div>
                                                    </div>
