...
<table class="table table-bordered">
    ...
    <?php if($model->isNewRecord){ ?>
        <tr>
            ...
            <td>
                <div class="editable" name="ProductExciesRate" id="ProductExciesSumma_1" rowid="1">0</div>
            </td>
            <td>
                <div class="editable" name="ProductExciesSumma" id="ProductExciesSumma_1" rowid="1">0</div>
            </td>
            <td>
