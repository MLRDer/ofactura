...
$this->registerJs("document.getElementById(\"BuyerTin\").value =".$model->BuyerTin." ; GetDataByTinV2ForUpdate(".$model->SellerTin.");ChangeTypeFactura(".$model->FacturaType.");",\yii\web\View::POS_END);
?>
