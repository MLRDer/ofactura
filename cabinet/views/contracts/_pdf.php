...
foreach ($clients as $itemCl){
    $client_name.=$itemCl->Name;
    $directCliengt .=$itemCl->Fio;
}
?>
    <p class="paragraph">
        <?= $model->Name ?> (бундан буён - “Бажарувчи” деб аталади) номидан ҳаракат қилувчи директор <b><?= $model->Fio ?></b>, бир томондан, ва <?= $client_name?> (бундан буён – “Буюртмачи” деб аталади) номидан ҳаракат қилувчи директор <b><?= $directCliengt?></b>, иккинчи томондан, биргаликда “Тарафлар”, алоҳида эса “Тараф” деб аталувчилар мазкур шартномани қуйидагилар ҳақида туздилар:
